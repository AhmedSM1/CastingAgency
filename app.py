...
def create_app(test_config=None):
    ...
    def create_actor(payload):
        ...
        if not (
                'name' in request_body and 'age' in request_body and 'email' in request_body and 'phone' in request_body):
            abort(400)
    ...
    def create_movie(payload):
        request_body = request.get_json()
        if not (
                'title' in request_body and 'release_date' in request_body and 'description' in request_body and 'genre' in request_body
